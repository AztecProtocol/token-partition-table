...
export class TokenContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** get_notes_at_offset(owner: struct, offset: integer) */
    get_notes_at_offset: ((owner: AztecAddressLike, offset: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** redeem_shield(to: struct, amount: field, block_number: integer, secret: field, num_shields: integer) */
    redeem_shield: ((to: AztecAddressLike, amount: FieldLike, block_number: (bigint | number), secret: FieldLike, num_shields: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** request_attestation(from: struct, attestor: struct, note_offset: integer, proofs: array, blacklist_root: field, nonce: field) */
    request_attestation: ((from: AztecAddressLike, attestor: AztecAddressLike, note_offset: (bigint | number), proofs: FieldLike[], blacklist_root: FieldLike, nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** unattested_note_at_offset(owner: struct, attestor: struct, offset: integer) */
    unattested_note_at_offset: ((owner: AztecAddressLike, attestor: AztecAddressLike, offset: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
